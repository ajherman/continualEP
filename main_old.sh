		...
		for trace_decay in {0.9,0.7,0.5}
			do
				...
				stdp_3_directory=stdp_3_"$i"
		 		...
		 		mkdir -p $nonspiking_directory
		 		mkdir -p $stdp_directory
		 		nohup python -u main.py --directory $spiking_directory --load True --spiking True --action train --activation-function hardsigm --size_tab 10 256 784 --lr_tab 0.0028 0.0056 --epochs 20 --T 40 --Kmax 15 --dt 0.3 --beta $beta --cep --learning-rule stdp --update-rule skewsym >> skewsym_spiking_log_b_"$i".out &
				nohup python -u main.py --directory $nonspiking_directory --load True --spiking False --action train --activation-function hardsigm --size_tab 10 256 784 --lr_tab 0.0028 0.0056 --epochs 20 --T 40 --Kmax 15 --dt 0.3 --beta $beta --cep --learning-rule stdp --update-rule skewsym >> skewsym_nonspiking_log_b_"$i".out &
				nohup python -u main.py --directory $stdp_0_directory --load True --spiking True --action train --trace-decay 0.9  --activation-function hardsigm --size_tab 10 256 784 --lr_tab 0.0028 0.0056 --epochs 20 --T 40 --Kmax 15 --dt 0.3 --beta $beta --cep --learning-rule stdp --update-rule stdp >> stdp_log_0_"$i".out &
				nohup python -u main.py --directory $stdp_1_directory --load True --spiking True --action train --trace-decay 0.7  --activation-function hardsigm --size_tab 10 256 784 --lr_tab 0.0028 0.0056 --epochs 20 --T 40 --Kmax 15 --dt 0.3 --beta $beta --cep --learning-rule stdp --update-rule stdp >> stdp_log_1_"$i".out &
				nohup python -u main.py --directory $stdp_2_directory --load True --spiking True --action train --trace-decay 0.5  --activation-function hardsigm --size_tab 10 256 784 --lr_tab 0.0028 0.0056 --epochs 20 --T 40 --Kmax 15 --dt 0.3 --beta $beta --cep --learning-rule stdp --update-rule stdp >> stdp_log_2_"$i".out &
		 		nohup python -u main.py --directory $stdp_3_directory --load True --spiking True --action train --trace-decay 0.4  --activation-function hardsigm --size_tab 10 256 784 --lr_tab 0.0028 0.0056 --epochs 20 --T 40 --Kmax 15 --dt 0.3 --beta $beta --cep --learning-rule stdp --update-rule stdp >> stdp_log_3_"$i".out
			done
			i=$((i+1))
		done
