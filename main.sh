...
srun -N 1 -n 1 -c $cores -o "$nonspiking_stdp1_dir".out --open-mode=append ./main_wrapper.sh --load --directory $nonspiking_stdp1_dir --n-dynamic $n_dynamic --action train --batch-size $batch_size --n-trace 0.2  --activation-function hardsigm --size_tab 10 $hidden_size 784 --lr_tab 0.0028 0.0056 --epochs $epochs --N1 $N1  --N2 $N2 --beta $beta --cep --learning-rule stdp --update-rule stdp &
srun -N 1 -n 1 -c $cores -o "$nonspiking_stdp2_dir".out --open-mode=append ./main_wrapper.sh --load --directory $nonspiking_stdp2_dir --n-dynamic $n_dynamic --action train --batch-size $batch_size --n-trace 1.0  --activation-function hardsigm --size_tab 10 $hidden_size 784 --lr_tab 0.0028 0.0056 --epochs $epochs --N1 $N1  --N2 $N2 --beta $beta --cep --learning-rule stdp --update-rule stdp &
i=$((i+1))
done
