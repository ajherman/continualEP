...
if __name__ == '__main__':
    ...
    with open(args.directory+'/params.txt', 'w',encoding='utf8') as f:
        keys = ['N1','N2','dt','size_tab','lr_tab','use_bias','no_reset','no_rhop','plain_data','update_rule','trace_decay','spiking','step','max_fr','max_Q','no_clamp','beta']
