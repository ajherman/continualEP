...
# beta=0.2
# labels=[]
# for idx,(batch_size,kmax) in enumerate(product(batch_size_li,kmax_li)):
#     step = 12./kmax
...
beta=0.9
labels=[]
for idx,(batch_size,kmax) in enumerate(product([25,200],kmax_li)):
    step = 12./kmax
    for activity_type,learning_rule in product(activity_type_li,learning_rule_li):
        if idx==0:
            labels.append(r''+activity_type+" "+learning_rule)
...
beta=0.2
labels=[]
for idx,(batch_size,kmax) in enumerate(product([25,50,100,200],kmax_li)):
    step = 12./kmax
    for activity_type,learning_rule in product(activity_type_li,learning_rule_li):
        if idx==0:
            labels.append(r''+activity_type+" "+learning_rule)
